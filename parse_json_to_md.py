...
def render_paper(paper_entry: dict, idx: int) -> str:
    ...
    paper_string = f'## {idx}. [{title}]({url}) <a id="link{idx}"></a>\n'
    paper_string += f"**ID:** {id}\n"
...
def render_md_string(papers_dict):
    ...
    title_strings = [
        ...
        for i, paper in enumerate(papers_dict)
    ]
    output_string = output_string + "\n".join(title_strings) + "\n---\n"
    # render each paper
    paper_strings = [
        render_paper(paper, i) for i, paper in enumerate(papers_dict)
    ]
